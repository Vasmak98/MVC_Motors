...
public class BuggiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buggies);
        ...
        reference = dbase.getReference("buggies");

        FloatingActionButton fab = findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(BuggiesActivity.this,"Press more information to visit manufacturer's site",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Motors,ViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Motors, ViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull Motors model) {
                ...
                holder.setDetails(BuggiesActivity.this,model.getImage(),model.getTitle(),model.getType(),model.url);
